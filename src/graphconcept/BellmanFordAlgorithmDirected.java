...
public class BellmanFordAlgorithmDirected {
    ...
    static void addEdge(ArrayList<Edge> graphs, int source, int destination, int weight){
        graphs.add(new Edge(source, destination, weight));
    }
...
//        addEdge(graph, 3, 4, -10);
        ...
        for (int i=0; i<distance.length; i++){
            System.out.println("distance form " + i + " " + distance[i]);
        }
